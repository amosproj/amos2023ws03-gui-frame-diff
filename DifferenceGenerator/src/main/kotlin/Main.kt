...
fun main(args: Array<String>) {
    ...
    val algorithm: AlignmentAlgorithm<Char> = Gotoh(metric, -10.0, -1.0)

    val a: Array<Char> = arrayOf('A', 'A', 'A', 'A', 'G', 'G', 'T', 'A', 'C', 'G', 'C', 'A', 'C', 'G', 'T')
    val b: Array<Char> = arrayOf('A', 'A', 'A', 'A', 'G', 'G', 'T', 'A', 'C', 'G', 'C', 'A', 'C', 'G', 'T')
